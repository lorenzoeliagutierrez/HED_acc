...
if (isset($_POST['submit'])) {
    ...
    if (mysqli_num_rows($check_miscell) == 0) {
        ...
        $edit_miscell = mysqli_query($db,"UPDATE tbl_miscellaneous_fees SET miscellaneous = '$miscellaneous', miscell_desc = '$miscell_desc', ay_id = '$ay_id', year_id = '$year_id', updated_by = '$updated_by', last_updated = CURRENT_TIMESTAMP WHERE miscell_id = $miscell_id");

...
if (isset($_POST['submit'])) {
    ...
    foreach ($year_array as $year_value) {
        ...
        $miscell_check = mysqli_query($acc, "SELECT * FROM tbl_lab_fees WHERE lab = '$lab' AND ay_id = '$ay_id' AND year_id = '$year_value'") or die(mysqli_error($acc));

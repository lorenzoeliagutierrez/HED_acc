                    ...
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic">
                                ...
                                <tbody>
                                    <?php
                                    $list_assessment = mysqli_query($db, "SELECT *, tbl_assessed_tf.sem_id, tbl_assessed_tf.ay_id, tbl_assessed_tf.updated_by, CONCAT(tbl_students.lastname, ', ', tbl_students.firstname, ' ', tbl_students.middlename)  as fullname FROM tbl_assessed_tf
                                    ...
                                    WHERE tbl_schoolyears.sem_id = '$sem_id' AND tbl_schoolyears.ay_id = '$ay_id'") or die(mysqli_error($db));
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $created_at->format('h:i a, F d, Y'); ?>
                                        </td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $last_updated->format('h:i a, F d, Y'); ?></td>
                                        <td class="text-sm font-weight-normal">

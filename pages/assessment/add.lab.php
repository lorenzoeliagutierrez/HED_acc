...
?>
<title>
    Add New Laboratory Fee | SFAC - Bacoor
</title>
</head>
<script>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">Add New Laboratory Fee</h6>
            ...
            <div class="row mb-10">
                <div class="col-lg-9 col-12 mx-auto">
                    <div class="card card-body mt-4 shadow-sm">
                        <h5 class="font-weight-bolder mb-0">Add Laboratory Fee</h5>
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.add.lab.php" autocomplete="off">
                            <div class="row">
                                <div class="col-sm-8">
                                    ...
                                    <input class="form-control" type="text" placeholder="Laboratory Fee Description"
                                        name="lab_desc" />
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <label class="mt-3">Laboratory Fee</label>
                                    <input class="form-control" type="text" placeholder="Enter Laboratory value" id="lab_1"
                                        name="lab1" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <label class="mt-3">Laboratory Fee</label>
                                    <input class="form-control" type="text" placeholder="Enter Laboratory value"  id="lab_2"
                                        name="lab2" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <label class="mt-3">Laboratory Fee</label>
                                    <input class="form-control" type="text" placeholder="Enter Laboratory value"  id="lab_3"
                                        name="lab3" />
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <label class="mt-3">Laboratory Fee</label>
                                    <input class="form-control" type="text" placeholder="Enter Laboratory value" id="lab_4"
                                        name="lab4" />
                                </div>
                            </div>

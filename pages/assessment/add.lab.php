...
?>
<title>
    Add Laboratory Fee | SFAC - Bacoor
</title>
</head>
...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">Add Laboratory Fee</h6>
            ...
            <div class="row mb-10">
                <div class="col-lg-9 col-12 mx-auto">
                    <div class="card card-body mt-4 shadow-sm">
                        ...
                        <form method="POST" enctype="multipart/form-data" action="userData/ctrl.add.lab.php">
                            <div class="row">
                                <div class="col-sm-6">

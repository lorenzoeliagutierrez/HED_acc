...
$('document').ready(function() {
    ...
    var table = $('#test_table').DataTable({
        ajax: {
            url: 'userData/ctrl.list.discount.php',
            type: 'POST',
            dataSrc: ''
        },
        columns: [
                { data: 'discount_desc' },
                  ...
                  { data: 'disc_id',
                    render: function (data, type, row) {
                        return '<a class="btn bg-gradient-primary text-xs" href="edit.discount.php?disc_id='+data+'"><i class="text-xs fas fa-edit"></i> Edit</a> <a class="btn btn-block bg-gradient-danger mb-3 text-xs" data-bs-toggle="modal" data-bs-target="#modal-notification'+data+'"><iclass="text-xs fas fa-trash-alt"></i> Delete</a>';
                    }
                }
        ],
                                                ...
                                                <div class="modal-body">
                                                    <div class="py-3 text-center">
                                                        ...
                                                        <p>Are you sure you want to delete
                                                            <br>
                                                            <i><b><?php echo $row['discount_desc']; ?></b></i>?
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.discount.php?disc_id=<?php echo $id; ?>"

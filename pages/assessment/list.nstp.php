...
<body class="g-sidenav-show  bg-gray-100">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
        ...
        <h6 class="font-weight-bolder mb-0">View NSTP Fees</h6>
                ...
                <div class="col-12">
                    <div class="card shadow shadow-xl">
                        ...
                        <div class="card-header">
                            <h5 class="mb-0">NSTP Fees List</h5>
                        ...
                        <div class="table-responsive px-4 my-4">
                            <table class="table table-flush table-hover nowrap responsive" id="datatable-basic">
                                ...
                                <tbody>
                                    <?php
                                    $list_nstp = mysqli_query($db, "SELECT * FROM tbl_nstp_fees LEFT JOIN tbl_year_levels ON tbl_year_levels.year_id = tbl_nstp_fees.year_id");
                                    while ($row = mysqli_fetch_array($list_nstp)) {
                                        $id = $row['nstp_id'];
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <?php echo $row['component']; ?></td>
                                        <td class="text-sm font-weight-normal">
                                            <?php echo number_format($row['component_value'], 2); ?></td>
                                        <td class="text-sm font-weight-normal">
                                        ...
                                        <td class="text-sm font-weight-normal">
                                            <a class="btn bg-gradient-primary text-xs"
                                                href="edit.nstp.php?nstp_id=<?php echo $id; ?>"><i
                                                ...
                                                <div class="modal-body">
                                                    <div class="py-3 text-center">
                                                        ...
                                                        <p>Are you sure you want to delete
                                                            <br>
                                                            <i><b><?php echo $row['component']; ?></b></i>?
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <a href="userData/ctrl.del.nstp.php?nstp_id=<?php echo $id; ?>"

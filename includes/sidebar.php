...
<li class="nav-item">
        ...
        <li class="nav-item mt-3">
            ...
            <li class="nav-item">
          <a class="nav-link  active" href="../accounting_db/index.php">
            ...
            <span class="nav-link-text ms-1">Accounting Dashboard</span>
          </a>
        </li>
        ...
        ';
            ...
            ';
            include '../../pages/assessment/accountConn/conn.php';
            date_default_timezone_set('Asia/Manila');

            $assesmentinfo = mysqli_query($acc, "SELECT * FROM tbl_assessed_tf WHERE stud_no = '$stud_no' AND ay_id = '$_SESSION[AYear]' AND sem_id = '$_SESSION[ASem]' AND payment IN ('trimestral', 'quarterly')");
            while ($row = mysqli_fetch_array($assesmentinfo)) {
                ...
                echo ' <li class="nav-item">
                <a class="nav-link" href="../assessment/assessment.fee.php?stud_no='.$stud_no.'">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fas fa-user-alt text-dark"></i>
                    </div>
                    <span class="nav-link-text ms-1">Follow-up payment</span> 
                    <span class="badge badge-primary mx-3">!</span>
                </a>
                </li>
            ';}}
            }
